...
<body>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Client Login System</h3>
				<table height="100" align="center">
					...
					<tr>
						...
						<td style="text-align:right;"><a href="signup.php">Click Here To SignUp</a></td>
					</tr>
				</table>
			</form>
			<?php
