			...
			?>
				...
				<?php
						if(isset($_POST['save'])){
							...
							$qry = "INSERT INTO client (fname,id_no,gender,email,phone,location,car_id,status,mpesa) VALUES('$fname','$id_no','$gender','$email','$phone','$location','$_GET[id]','Pending','MPTOKENXYZ')";
